...
#time python copasi_make_benchmarks.py egfr_net directMethod 1 2 5 10

echo "Starts benchmark runs on the BCR model."
time python copasi_make_benchmarks.py BCR deterministic 1 2 5 10

echo "Starts benchmark runs on the fceri_gamma2 model."
time python copasi_make_benchmarks.py fceri_gamma2 deterministic 1 2 5 10
#time python copasi_make_benchmarks.py fceri_gamma2 directMethod 1 2 5 10
